...
INSERT INTO `client` VALUES (1,'gabriel','1234','2022-10-06 19:07:51',1),(2,'natalia','123','2022-10-06 19:28:45',1);
...
old_password_input varchar(100),
new_password_input varchar(100))
begin
	update client c
...
is_premium_input varchar(100))
    MODIFIES SQL DATA
begin
	insert into client(username, password, created_at, is_premium)
